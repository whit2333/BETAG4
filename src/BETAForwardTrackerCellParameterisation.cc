...
BETAForwardTrackerCellParameterisation::BETAForwardTrackerCellParameterisation(G4Material * aMaterial)
{
...
BETAForwardTrackerCellParameterisation::~BETAForwardTrackerCellParameterisation() {}

void BETAForwardTrackerCellParameterisation::ComputeTransformation ( const G4int copyNo,G4VPhysicalVolume *physVol ) const
{
   physVol->SetTranslation ( G4ThreeVector ( xCell[copyNo],yCell[copyNo],zCell[copyNo] ) );
}

G4VSolid* BETAForwardTrackerCellParameterisation::ComputeSolid
...
G4Material* BETAForwardTrackerCellParameterisation::ComputeMaterial // material, sensitivity, visAtt
( const G4int copyNo, G4VPhysicalVolume* physVol,
