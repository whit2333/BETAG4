...
// Wed Nov  4 19:53:13 2009 by ROOT version 5.25/02
// from TTree Detectors/Detector Tree
// found on file: ../data/beta.run.23838.root
//////////////////////////////////////////////////////////

#ifndef DataQualityCheck_h
#define DataQualityCheck_h
...
class DataQualityCheck : public TSelector {
public :
...
TH2F * mc_x_VS_mc_y ;
 ...
 //BETAEvent       *aBetaEvent;
   ...
   TBranch        *b_aBetaEvent_mc_theta;   //!
   TBranch        *b_aBetaEvent_mc_phi;   //!
   TBranch        *b_aBetaEvent_mc_e;   //!
   TBranch        *b_aBetaEvent_mc_bc_x;   //!
   TBranch        *b_aBetaEvent_mc_bc_y;   //!
   TBranch        *b_aBetaEvent_mc_bc_e;   //!
   TBranch        *b_aBetaEvent_mc_bc_n_pid;   //!
   TBranch        *b_aBetaEvent_mc_bc_n_hit;   //!

   DataQualityCheck(TTree * /*tree*/ =0) { }
   virtual ~DataQualityCheck() { }
   ...
   ClassDef(DataQualityCheck,0);
};

#endif

#ifdef DataQualityCheck_cxx
void DataQualityCheck::Init(TTree *tree)
{
   ...
   fChain->SetBranchAddress("x1t_x[100]", x1t_x, &b_aBetaEvent_x1t_x);
   ...
   fChain->SetBranchAddress("mc_theta[5]", mc_theta, &b_aBetaEvent_mc_theta);
   fChain->SetBranchAddress("mc_phi[5]", mc_phi, &b_aBetaEvent_mc_phi);
   fChain->SetBranchAddress("mc_e[5]", mc_e, &b_aBetaEvent_mc_e);
   fChain->SetBranchAddress("mc_bc_x[5]", mc_bc_x, &b_aBetaEvent_mc_bc_x);
   fChain->SetBranchAddress("mc_bc_y[5]", mc_bc_y, &b_aBetaEvent_mc_bc_y);
   fChain->SetBranchAddress("mc_bc_e[5]", mc_bc_e, &b_aBetaEvent_mc_bc_e);
   fChain->SetBranchAddress("mc_bc_n_pid[5]", mc_bc_n_pid, &b_aBetaEvent_mc_bc_n_pid);
   fChain->SetBranchAddress("mc_bc_n_hit", &mc_bc_n_hit, &b_aBetaEvent_mc_bc_n_hit);
}

Bool_t DataQualityCheck::Notify()
{
...
#endif // #ifdef DataQualityCheck_cxx
